        ...
        <div class="contact-alumni-page">
            <div class="mb-5">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <li class="page-item"> <a class="page-link prev" href="find-alumni-full-details/" tabindex="-1"><i class="fa fa-chevron-left pr-1" aria-hidden="true"></i> Previous</a> </li>
                    </ul>
                </nav>
            </div>
                            ...
                            <div class="text-center">
                                <div class="service-box-top">
                                    <div class="developer-name-area">
                                        <h2 class="name regular mb-3">Irinia Kurkina</h2>
                                    </div>
                                    ...
                                    <div class="developer-short-info mb-4">
                                        ...
                                        <small class="exp-text">6+ years experience</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="py-4">
                            <div class="heading mb-4">
                                <h3 class="regular"><strong>Request to contact</strong> Irinia Kurkina  </h3> 
                            </div>
                            ...
                            <form>
                                <div class="px-3">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="inputCountry3" class="col-sm-3 col-form-label">Country:</label>
                                            <div class="col-sm-9 align-self-center">
...
$(document).ready(function () {
    ...
    $('body').scrollspy({ target: '#application-summary' })
